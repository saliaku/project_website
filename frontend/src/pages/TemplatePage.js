...
const __template = () => {
  ...
  return (
    <div className="relative w-full min-h-screen bg-gradient-to-br from-violet-900 via-indigo-900 to-purple-900 overflow-hidden flex flex-col items-center justify-center">
